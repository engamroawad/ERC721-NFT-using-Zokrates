...
contract Ownable {
    ...
    event OwnerTransfered(address newOnwer);
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        require(msg.sender==tx.origin,"must be real address");
         _owner=newOwner;
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != ownerOf(tokenId),"address can't be token Owner");
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender==getOwner() || isApprovedForAll(getOwner(),to),"not approved for all or caller is not onwer");
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(_tokenOwner[tokenId]!=to && to!=address(0), "can't mint token because token already exisits!");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(from==ownerOf(tokenId),"from is not the owner of the token");
...
contract ERC721Metadata is ERC721Enumerable, usingOraclize {
    ...
    function setTokenURI(uint256 tokenId) internal {
        require(_exists(tokenId));
        string memory temp=uint2str(tokenId);
        _tokenURIs[tokenId]=strConcat(_baseTokenURI,temp);
    }
...
contract CustomERC721Token is ERC721Metadata{
    ...
    constructor() ERC721Metadata("capstone","CAP","https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") public {
    ...
    onlyOwner
    returns(bool){
        //TODO: what is the purpose of tokenURI as parameter?
        super._mint(to,tokenId);
        setTokenURI(tokenId);
        return true;
    }
